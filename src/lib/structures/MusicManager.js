...
class MusicManager {
	...
	constructor(guild) {
		...
		/**
		 * The PikaBotGuild instance that manages this instance
		 * @since 1.0.0
		 * @type {PikaBotGuild}
	...
	/**
	 * The VoiceChannel PikaBot is connected to
	 * @since 1.0.0
	 * @type {?VoiceChannel}
	 * @readonly
	 */
	...
	/**
	 * Whether PikaBot is playing a song or not
	 * @since 2.0.0
	 * @type {boolean}
	 * @readonly
	 */
	...
	/**
	 * Whether PikaBot has the queue paused or not
	 * @since 2.0.0
	 * @type {?boolean}
	 * @readonly
	 */
	...
	/**
	 * Whether PikaBot is doing nothing
	 * @since 2.0.0
	 * @type {boolean}
	 * @readonly
	 */
